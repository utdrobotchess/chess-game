...
public class RemoteController 
{
		...
		CommunicatorAPI xbee = new CommunicatorAPI();
			...
			while(!controller.isButtonPressed(6))
			{
				...
				//the following line is temporary. It will be removed in the future.
					xbee.SendMessage(temp, destinationAddresses[botAddressIndex],1);
	...
	public static void SetDestinationAddresses(int[][] addressList)
	{
		destinationAddresses = addressList;
	}
		
	public static void PrintControllerLayout()
	{
