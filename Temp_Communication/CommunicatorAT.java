...
import java.util.*;
	...
	//----------------------------------------------------------------------------------------------------------------------------------------------------	
		public static void main(String[] args) throws Exception 
		{
			...
			main.InitializeCommunication("COM26", 57600);
	...
	//----------------------------------------------------------------------------------------------------------------------------------------------------	
		...
		private synchronized void writeByte(char data)
		{
			...
			{
				PrintString("[GLaDOS] couldn't write to port. You weren't even testing for that.");
			}
		}
		
		public void InitializeCommunication(String COM, int BAUD_RATE)
		{
			...
			if(portID == null)
			{
				PrintString("[GLaDOS] specific COM port not found.");
			}
			...
			{
				PrintString("[GlaDOS] Initialization problem. Debug on your own recognisense.");
				System.exit(0);
			}
		}
		...
		public synchronized void serialEvent(SerialPortEvent oEvent)
		{
			if(oEvent.getEventType() == SerialPortEvent.DATA_AVAILABLE)
			{
				...
				{
					PrintString("[Problem] could not write to message.");
					System.exit(0);
				}
			}
		}
