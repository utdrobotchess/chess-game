			...
			xbee.addPacketListener(new PacketListener() {
				...
				public void processResponse(XBeeResponse response) {
					if (response.getApiId() == ApiId.AT_RESPONSE) {
						...
						System.out.println("\n	"+ByteUtils.toBase16(nd.getNodeAddress64().getAddress()) +"\n");
						//log.debug("Node discover response is: " + nd);
					} else {
						System.out.print("\n unexpected response: " + NodeDiscover.parse((AtCommandResponse)response).getNodeAddress64()+"\n");	
					}					
				}
